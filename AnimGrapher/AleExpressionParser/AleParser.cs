...
namespace AleProjects.AleLexer.AleParser
{
    ...
    public partial class AleExpressionParser : AleSimpleLexer
    {
        ...
        new public const uint OPTION_DEFAULT = OPTION_STRICTSYNTAX + OPTION_ALLOWMULTIDIMINDEXES + OPTION_STRICTINDEXES + OPTION_ALLOWEMPTYPARAMS;

        public const string DEFAULT_PAIRSEPARATOR = ":";
        new public const string DEFAULT_KEYVALUESEPARATOR = "=>";
